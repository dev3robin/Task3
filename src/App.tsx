...
function App() {
  ...
  return (
    <>
      <nav ref={navRef} className='px-5 z-100 py-3 flex justify-between border-b-2 border-gray-600 rounded-b-2xl bg-transparent backdrop-blur-2xl fixed top-0 w-full'>
        <h1 className='text-2xl font-extrabold'>{t("nav.intro")}</h1>
        <div className='flex'>
          <div className='relative group'>
            <button className='flex items-center gap-.5 p-1 pl-2 rounded hover:bg-amber-50/50' onClick={()=>toggleTheme()}>
          ...
          <div className='relative group'>
            <button 
              ...
              className='flex items-center gap-.5 p-1 pl-2 rounded hover:bg-amber-50/50'>
